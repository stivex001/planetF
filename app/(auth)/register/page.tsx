...
const Register = (props: Props) => {
  return (
    <div className="bg-[#164e63] h-screen flex justify-center items-center ">
      <div className="bg-white shadow-lg rounded-md mx-auto my-auto w-[90%] sm:w-3/4 sm:px-8 lg:w-2/4 xl:ml-20 xl:w-auto xl:bg-transparent xl:p-0 xl:shadow-none px-5 py-8">
